...
| `/tdd` | 测试驱动开发工作流 | 新功能开发 |
| `/plan` | 实现计划生成 | 复杂任务规划 |
| `/code-review` | [代码审查](../เอกสารอ้างอิง/commands/01-Workflowหลัก.md) | 代码质量检查 |
| `/build-fix` | [构建修复](../เอกสารอ้างอิง/commands/04-แก้ไขBuild.md) | 构建失败时 |
| `/learn` | 从会话提取模式 | 知识沉淀 |
| `/skill-create` | 从 Git 生成 Skill | 经验复用 |
| `/test` | [测试相关命令](../เอกสารอ้างอิง/commands/02-การทดสอบ.md) | 测试相关 |
