...
> **⚠️ Aviso sobre Versões Multilíngues**
> 
> Documentos de tradução em outros idiomas (inglês, japonês, coreano, alemão, russo, turco, vietnamita, tailandês) contêm numerosos erros de tradução. Due a limitações pessoais, não consigo continuar mantendo e corrigindo estes conteúdos.
> 
> Se você quiser ajudar a corrigir a tradução de um idioma específico, envie um Pull Request.
> 
> **Atualmente, apenas a versão em chinês é mantida ativamente.**
...
Eu tinha dificuldades com a documentação em inglês do ECC. Por isso, traduzi as explicações sobre comandos ECC (Commands), Agents, Skills, etc. para o português e organizei este curso de aprendizado.
...
**Documentação de Referência** (./DocumentosDeReferência/) é uma tradução para português do projeto ECC. Traduzi a documentação em inglês do ECC para o português para facilitar a consulta.
...
- [Exercícios para Iniciantes](./1-Introdução/exercises/ExercíciosdeIniciação.md) - Consolide os fundamentos
...
Nenhum. A fase de iniciante é projetada para base zero.
...
```
Learn-ECC/
├── 1-Introdução/                         # Fase 1: Introdução (2-3 horas)
...
│   └── exercises/
│       └── ExercíciosdeIniciação.md      # 4 exercícios para iniciantes
│
├── 2-HabilidadesCentrais/                     # Fase 2: Habilidades Essenciais (8-12 horas)
│   ├── 01-SistemaDeComandos/
│   ├── 02-ColaboraçãoDeAgentes/
│   ├── 03-PersonalizaçãoDeHooks/
│   ├── 04-DesenvolvimentoDeSkills/
│   └── 05-CriaçãoDeRules/
│
...
2. **Pratique hands-on**: Pratique imediatamente cada conceito, não apenas leia
